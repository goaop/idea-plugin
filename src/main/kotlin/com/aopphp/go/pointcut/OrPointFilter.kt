...
class OrPointFilter(private val first: PointFilter, private val second: PointFilter) : PointFilter {
    private val _kind = first.getKind() + second.getKind()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is OrPointFilter) return false
