...
public class DynamicExecutionPointcutImpl extends ASTWrapperPsiElement implements DynamicExecutionPointcut {

  public DynamicExecutionPointcutImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitDynamicExecutionPointcut(this);
