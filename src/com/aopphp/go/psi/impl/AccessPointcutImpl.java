...
public class AccessPointcutImpl extends ASTWrapperPsiElement implements AccessPointcut {

  public AccessPointcutImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitAccessPointcut(this);
